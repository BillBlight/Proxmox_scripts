...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/BillBlight/Proxmox_scripts/mine/misc/copy-data/home-assistant-container-copy-data-home-assistant-core.sh)"
