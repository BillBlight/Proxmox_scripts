...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/BillBlight/Proxmox_scripts/main/misc/copy-data/home-assistant-container-copy-data-home-assistant-core.sh)"
